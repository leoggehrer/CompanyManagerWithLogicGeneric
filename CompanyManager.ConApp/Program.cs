...
namespace CompanyManager.ConApp
{
    internal class Program
    {
        ...
        private static void PrintCompanyies(Logic.Contracts.IContext context)
        {
            ...
            foreach (var company in context.CompanySet.QuerySet.Include(e => e.Customers))
            {
        ...
        private static void QueryCompanies(Logic.Contracts.IContext context)
        {
            ...
            try
            {
                foreach (var company in context.CompanySet.QuerySet.Where(query).Include(e => e.Customers))
                {
                    Console.WriteLine($"{company}");
                    foreach (var customer in company.Customers)
                    {
        ...
        private static void DeleteCompany(Logic.Contracts.IContext context)
        {
            ...
            var entity = context.CompanySet.QuerySet.FirstOrDefault(e => e.Name == name);
        ...
        private static void PrintCustomers(Logic.Contracts.IContext context)
        {
            ...
            foreach (var item in context.CustomerSet.QuerySet.AsNoTracking())
            {
        ...
        private static void QueryCustomers(Logic.Contracts.IContext context)
        {
            ...
            try
            {
                foreach (var customer in context.CustomerSet.QuerySet.AsNoTracking().Where(query).Include(e => e.Company))
                {
        ...
        private static void AddCustomer(Logic.Contracts.IContext context)
        {
            ...
            var company = context.CompanySet.QuerySet.FirstOrDefault(x => x.Name == companyName);
            ...
            while (company == null && count < 3)
            {
                ...
                company = context.CompanySet.QuerySet.FirstOrDefault(x => x.Name == companyName);
            }
            try
            {
                if (company != null)
        ...
        private static void DeleteCustomer(Logic.Contracts.IContext context)
        {
            ...
            var entity = context.CustomerSet.QuerySet.FirstOrDefault(e => e.Email == email);
        ...
        private static void PrintEmployees(Logic.Contracts.IContext context)
        {
            ...
            foreach (var item in context.EmployeeSet.QuerySet.AsNoTracking())
            {
                Console.WriteLine($"{item}");
            }
        }
        ...
        private static void DeleteEmployee(Logic.Contracts.IContext context)
        {
            ...
            Console.Write("Email: ");
            var email = Console.ReadLine()!;
            var entity = context.EmployeeSet.QuerySet.FirstOrDefault(e => e.Email == email);
